...
<body>
     <div class="container">
          ...
          <?php
               $i = 1;
               do {
                    $sql1 = "SELECT ds.codigo, ds.nome, ds.ch, cr.nome AS curso FROM disciplina ds, composto cm, projeto pj, curso cr
                    WHERE ds.codigo = cm.cod_disc AND cm.num_proj = pj.numero AND pj.num_curso = cr.numero AND cr.nome = '".$linha2['nome']."'";
          ...
          <?php
                         ...
                         echo "<h3 class='text-center'>Nenhuma disciplina encontrada</h3>";
                    }
                    echo "</div>";
                    $i++;
               } while($linha2 = pg_fetch_assoc($dados2));
